...
- metadata:
  ...
  non-missing character or numeric vectors. Vectors of length one are
  written as scalar strings or 64-bit floats; other lengths become GGUF
  arrays of the corresponding type. Defaults to
