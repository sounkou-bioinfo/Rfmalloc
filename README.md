...
as a sentinel. The evaluated example traverses the real GGUF loader,
borrowed weight spans, transformer graph, KV cache, generation loop and
byte decoder without a model download. Its output is a systems check,
