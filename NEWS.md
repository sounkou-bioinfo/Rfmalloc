...
- Updated known limitation notes around operator-family completeness; core paths now dispatch but a full rewrite across all base generics is still in progress.
