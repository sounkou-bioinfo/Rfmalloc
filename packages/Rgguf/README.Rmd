...
never materialized. Rgguf registers gguflib's `q4_0`, `q4_1`, `q8_0`, `q2_k`,
`q4_k`, and `q6_k` dequantizers as Rfmalloc tensor codecs; `f32`, `f16`,
...
GPL (>= 2). Bundled third-party code (gguflib, fp16, bf16) remains under its
upstream MIT license, which is GPL-compatible; it is documented and separately
