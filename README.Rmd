...
- Core `Ops`, `Summary`, and matrix `rowSums`/`colSums`/`rowMeans`/`colMeans`
  methods now dispatch through S3 methods to keep behaviour closer to native
  vector/matrix operations.
- Full operator- and method-family coverage is still incomplete; some advanced
  expressions may still materialize ordinary R objects in edge-case paths.
