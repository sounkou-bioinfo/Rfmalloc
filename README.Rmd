...
dtype/dims tags. Matrix products decode the payload in bounded, block-aligned
column panels streamed through `dgemm`, so the full double representation is
never materialized. Codecs `f64`, `f32`, `f16`, and `bf16` are builtin;
