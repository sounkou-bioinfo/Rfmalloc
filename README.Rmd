...
Runtime-SIMD-dispatched quantized kernels (the ggml `GGML_CPU_ALL_VARIANTS`
path, à la [RsimdDispatch](https://github.com/sounkou-bioinfo/RsimdDispatch))
are the next planned step for the dequant-dot path that BLAS cannot cover.
