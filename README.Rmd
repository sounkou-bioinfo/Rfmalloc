...
Still experimental: view-based subsets (currently copy-only; true views would
form an additional semantic layer), richer catalog maintenance tooling, and
...
default-runtime lookup, catalog listing, and an API-version query. Returned
