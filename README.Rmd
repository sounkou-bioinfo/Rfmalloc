...
init_fmalloc(huge_file, size_gb = 20)

big_vec <- create_fmalloc_vector("integer", 10^8) 
...
- Single vector: Up to 1 BILLION elements (~4GB)
- Sparse allocation with random access patterns
- Gigabyte-scale single data structure capability
