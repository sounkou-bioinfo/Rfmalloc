...
#'   \item{\code{\link{fmalloc_pca}}}{Out-of-core PCA and variance reductions for genomics (single-cell) workflows.}
...
#'           \item Matrix products use BLAS `dgemm` for finite numeric
