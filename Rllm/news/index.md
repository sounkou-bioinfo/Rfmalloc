...
- Added a small deterministic tokenizer-bearing GGUF model for evaluated
  README inference. Its reproducible recipe exercises the real loader,
  borrowed weight spans, transformer graph, KV cache, generation loop,
  and raw-byte decoder without a download or a success-shaped
  unevaluated transcript.
